        ...
        <div class="text-center">
            <div class="my-5">
                ...
                <p class="fs-h3 text-muted">
                    We've sent you a reset password link.<br />
                    Please click the button within email message to reset your password.
                </p>
            </div>
            <div class="text-center text-muted mt-3">
                Can't see the email? Please check the spam folder.<br />
                Wrong email? Please <a href="<?= base_url('auth/forgot_password') ?>">re-enter your address</a>.
            </div>
        </div>
    </div>
</div>