        ...
        <div class="container">
            ...
            <div class="row mt-1 shadow">
                <div class="col bg-white p-5">
                    ...
                    <p>You have requested to change email address. Please verify your email by click the button bellow. You have <?= $duration ?? '0'; ?> minutes before this action is expired.</p>
                    <div class="my-3">
                        <a target="_blank" href="<?= $url; ?>" class="btn btn-primary"><?= $button_text ?? 'Verify Email Address'; ?></a>
                    </div>
                    <p>If you did not request change email address, no further action is required.</p>
                    <p>Regards,</p>
                    <p><?= $app_name ?? 'Codeigniter 3 Auth'; ?></p>
                    <hr>
                    <div>
                        <span class="d-block text-xs text-wrap text-muted">
                            If you’re having trouble clicking the "<?= $button_text ?? 'Verify Email Address'; ?>" button, copy and paste the URL below into your web browser: <a href="<?= $url; ?>"><?= $url ?? 'http://ci3-auth.test/auth/verify/change_email?email=&token='; ?></a>
                        </span>
                    </div>
                </div>
            </div>
