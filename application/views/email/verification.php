        ...
        <div class="container">
            ...
            <div class="row mt-1 shadow">
                <div class="col bg-white p-5">
                    <p>Welcome, <strong><?= $full_name ?? 'New User'; ?>!</strong></p>
                    <p>Thank you for registering to our applications. Please verify your email by click the button bellow. You have <?= $duration ?? '0'; ?> minutes before this action is expired.</p>
                    <div class="my-3">
                    ...
                    <div>
                        <span class="d-block text-xs text-wrap text-muted">
                            If you’re having trouble clicking the "<?= $button_text ?? 'Verify Email Address'; ?>" button, copy and paste the URL below into your web browser: <a href="<?= $url; ?>"><?= $url ?? 'http://ci3-auth.test/auth/verify?email=&token='; ?></a>
                        </span>
                    </div>
                </div>
            </div>
