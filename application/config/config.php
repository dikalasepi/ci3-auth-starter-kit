...
|
*/
$config['base_url'] = 'http://ci3-auth.test:8888';
...
|--------------------------------------------------------------------------
|
| 'cookie_expiration' = Set cookie duration in seconds
...
$config['csrf_token_name'] = 'csrf_token_ci3';
$config['csrf_cookie_name'] = 'csrf_cookie_ci3';
...
| Timezone
|--------------------------------------------------------------------------
| Option to setting timezone that will be used. This option will be
| argument for 'date_default_timezone_set()' function.
| When you use 'time()' function, it returns UNIX timestamp. So if you want
| to format the result you can use with 'date()' function. For example:
